package com.ubit.wallet.scanner.view;
...
import com.ubit.wallet.utils.ScreenUtils;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        textPaint.setColor(resources.getColor(R.color.color_ff_ff_ff));
        textPaint.setTextSize(ScreenUtils.dip2px(getContext(), 15));


        net_work_textPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        net_work_textPaint.setTextAlign(Align.CENTER);
        net_work_textPaint.setColor(resources.getColor(R.color.color_ff_ff_ff));
        net_work_textPaint.setTextSize(ScreenUtils.dip2px(getContext(), 18));
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawText(getContext().getString(R.string.zxing_top_hint), (frame.left + frame.right) / 2, frame.bottom + ScreenUtils.dip2px(getContext(), 23), textPaint);
        if (drawNetWork) {
            canvas.drawText(getContext().getString(R.string.network_excption), (frame.left + frame.right) / 2, (frame.top + frame.bottom) / 2 - ScreenUtils.dip2px(getContext(), 20), net_work_textPaint);
            canvas.drawText(getContext().getString(R.string.network_excption), (frame.left + frame.right) / 2, (frame.top + frame.bottom) / 2 + ScreenUtils.dip2px(getContext(), 20), net_work_textPaint);
        } else {
            // �����ĸ��
